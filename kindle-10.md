...
MobileRead Package Installer（[MRPI](https://fw.notmarek.com/khf/#:~:text=MRPI%20%2D%20modified%20to%20support%20HF)），用来安装插件。KUAL (即 Kindle Unified Application Launcher)，插件启动器。USBNetwork 用来支持通过 ssh 链接 kindle。
  ...
  3. 下载 [USBNetwork](https://github.com/notmarek/kindle-usbnetlite/releases)，把 Update_usbnetlite_xxx.bin 拷贝到 MRPI 的 mrpackages 文件夹中；

...
## 操作环境
- [Kindle KT4 ](https://bookfere.com/post/1145.html) ([第 10 代，序列号 G0910L](https://wiki.mobileread.com/wiki/Kindle_Serial_Numbers))，固件版本 5.17.1.0.3，内存 3GB。
- MacBook Air m2
...
> 注： KOReader 其实内部已经集成了 SSH 和 SFTP 服务端， USBNetwork 是为了更快捷地启动 ssh。
